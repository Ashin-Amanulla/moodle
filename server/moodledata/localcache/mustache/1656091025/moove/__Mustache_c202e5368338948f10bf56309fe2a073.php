...
class __Mustache_c202e5368338948f10bf56309fe2a073 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section94c74889bd68ac742c1dfd661dee2e52($context, $indent, $value);
        // 'output.should_display_logo' inverted section
        $value = $context->findDot('output.should_display_logo');
        if (empty($value)) {
...
';
        ...
        $buffer .= $this->section1c1a5f1a44e36572de24594b6aecda53($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
    ...
    private function section94c74889bd68ac742c1dfd661dee2e52(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1c1a5f1a44e36572de24594b6aecda53(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
